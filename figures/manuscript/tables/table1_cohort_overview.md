...
Footnotes: Encounters with missing or unclassified payer documentation were excluded; Cox models use private (reference), Medicare, and Medicaid. Language undocumented is descriptive only (excluded from Cox models). Policy eras in models use 5-year bins on de-identified MIMIC years (sparse eras collapsed).